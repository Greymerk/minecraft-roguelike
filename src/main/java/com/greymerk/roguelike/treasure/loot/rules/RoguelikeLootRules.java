...
public class RoguelikeLootRules {
	...
	public static LootRuleManager getLoot() {
		...
		for(int difficulty = 0; difficulty < 5; ++difficulty){
			...
			lootRules.add(Treasure.ARMOUR, loot.get(Loot.ARMOUR, difficulty),  difficulty, true, 2);
			lootRules.add(Treasure.ARMOUR, loot.get(Loot.FOOD, difficulty),  difficulty, true, 3);
			lootRules.add(Treasure.WEAPONS, loot.get(Loot.POTION, difficulty),  difficulty, true, 1);
			lootRules.add(Treasure.WEAPONS, loot.get(Loot.WEAPON, difficulty),  difficulty, true, 2);
			lootRules.add(Treasure.WEAPONS, loot.get(Loot.FOOD, difficulty),  difficulty, true, 3);
			...
			lootRules.add(Treasure.FOOD, loot.get(Loot.FOOD, difficulty),  difficulty, true, 8);
			...
			lootRules.add(Treasure.TOOLS, loot.get(Loot.ORE, difficulty),  difficulty, true, 3);
			lootRules.add(Treasure.TOOLS, loot.get(Loot.TOOL, difficulty),  difficulty, true, 2);
			lootRules.add(Treasure.TOOLS, loot.get(Loot.BLOCK, difficulty),  difficulty, true, 3);
			lootRules.add(Treasure.SUPPLIES, loot.get(Loot.SUPPLY, difficulty),  difficulty, true, 4);
			lootRules.add(Treasure.SUPPLIES, loot.get(Loot.BLOCK, difficulty),  difficulty, true, 2);
			lootRules.add(Treasure.SUPPLIES, loot.get(Loot.FOOD, difficulty),  difficulty, true, 3);
