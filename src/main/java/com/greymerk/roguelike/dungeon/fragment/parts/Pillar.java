...
public class Pillar {
	...
	public static void generate(IWorldEditor editor, RandomSource rand, Coord origin, ITheme theme, int height) {
		generate(editor, rand, origin, theme, height, Cardinal.directions);
	}
	
	public static void generate(IWorldEditor editor, RandomSource rand, Coord origin, ITheme theme, int height, List<Cardinal> directions) {
		generate(editor, rand, origin, theme.getPrimary(), height, directions);
	}
	
	public static void generate(IWorldEditor editor, RandomSource rand, Coord origin, IBlockSet blocks, int height, List<Cardinal> directions) {
