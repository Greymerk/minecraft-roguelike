...
public class BTeamRoom extends AbstractRoom implements IRoom {
	...
	public void generate(IWorldEditor editor) {
		...
		RandomSource rand = editor.getRandom(outside);
	...
	private void decor(IWorldEditor editor, RandomSource rand, Coord origin) {
	...
	private void emeraldB(IWorldEditor editor, RandomSource rand, Coord origin) {
	...
	private void lamps(IWorldEditor editor, RandomSource rand, Coord origin) {
		Cardinal.orthogonal(direction).forEach(o -> {
	...
	private void lamp(IWorldEditor editor, RandomSource rand, Coord origin, Cardinal dir) {
	...
	private void passage(IWorldEditor editor, RandomSource rand, Coord origin) {
