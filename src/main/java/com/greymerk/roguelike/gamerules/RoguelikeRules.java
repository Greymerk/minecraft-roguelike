...
public class RoguelikeRules {
	...
	public static final GameRule<Boolean> GEN_ROGUELIKE_DUNGEONS = GameRuleBuilder.forBoolean(true).buildAndRegister(Identifier.fromNamespaceAndPath(Roguelike.MODID, id));
