...
public enum FlowerPot {
	...
	public static MetaBlock getFlower(FlowerPot type){
		switch(type){
		case DANDELION: return new MetaBlock(Blocks.yellow_flower);
		case POPPY: return new MetaBlock(Blocks.red_flower, 0);
		case ORCHID: return new MetaBlock(Blocks.red_flower, 1);
		case ALLIUM: return new MetaBlock(Blocks.red_flower, 2);
		case BLUET: return new MetaBlock(Blocks.red_flower, 3);
		case REDTULIP: return new MetaBlock(Blocks.red_flower, 4);
		case ORANGETULIP: return new MetaBlock(Blocks.red_flower, 5);
		case WHITETULIP: return new MetaBlock(Blocks.red_flower, 6);
		case PINKTULIP: return new MetaBlock(Blocks.red_flower, 7);
		case DAISY: return new MetaBlock(Blocks.red_flower, 8);
		case REDMUSHROOM: return new MetaBlock(Blocks.red_mushroom);
		case BROWNMUSHROOM: return new MetaBlock(Blocks.brown_mushroom);
		case CACTUS: return new MetaBlock(Blocks.cactus);
		case OAK: return new MetaBlock(Blocks.sapling, 0);
		case SPRUCE: return new MetaBlock(Blocks.sapling, 1);
		case BIRCH: return new MetaBlock(Blocks.sapling, 2);
		case JUNGLE: return new MetaBlock(Blocks.sapling, 3);
		case ACACIA: return new MetaBlock(Blocks.sapling, 4);
		case DARKOAK: return new MetaBlock(Blocks.sapling, 5);
		case SHRUB: return new MetaBlock(Blocks.tallgrass, 0);
		case FERN: return new MetaBlock(Blocks.tallgrass, 2);
		default: return new MetaBlock(Blocks.yellow_flower);
		}
	}
}
