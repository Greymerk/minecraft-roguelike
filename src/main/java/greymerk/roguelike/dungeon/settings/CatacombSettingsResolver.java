...
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsBasicLoot;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsDesertTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsEniTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsEthoTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsForestTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsJungleTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsMountainTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsPyramidTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsRooms;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsSecrets;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsSegments;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsSize;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsSwampTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsTempleTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsTheme;
import greymerk.roguelike.dungeon.settings.builtin.CatacombSettingsWitchTheme;
