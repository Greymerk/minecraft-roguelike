...
public class CatacombTunneler {
	...
	public void construct(World world){
		...
		IBlockFactory fillBlocks = BlockFactoryProvider.getRandomizer(Dungeon.getRank(originY), rand);
		
		int bridgeBlock = Dungeon.getRank(originY) == 3 ? Block.netherrack.blockID : Block.cobblestone.blockID;
