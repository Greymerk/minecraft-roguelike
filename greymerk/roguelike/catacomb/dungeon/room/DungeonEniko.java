...
public class DungeonEniko implements IDungeon {
	...
	public boolean generate(World world, Random rand, ITheme theme, int x, int y, int z) {
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y + 1, z - 4, x - 6, y + 3, z - 3, Block.coalBlock.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y, z - 4, x - 5, y, z - 3, shelf, true, true);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y + 1, z + 3, x - 6, y + 3, z + 4, Block.coalBlock.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y + 1, z - 6, x - 3, y + 3, z - 6, Block.coalBlock.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y, z - 5, x - 3, y, z - 5, shelf, true, true);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y + 1, z - 6, x + 4, y + 3, z - 6, Block.coalBlock.blockID);
		...
		// floor
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z - 5, x + 5, y - 1, z + 5, Block.stoneBrick.blockID);
		...
		// roof
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y + 4, z - 6, x - 4, y + 4, z + 6, Block.netherBrick.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 3, y + 4, z - 6, x + 4, y + 4, z - 4, Block.netherBrick.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 3, y + 4, z + 4, x + 4, y + 4, z + 6, Block.netherBrick.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 4, y + 4, z - 6, x + 6, y + 4, z + 6, Block.netherBrick.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y + 5, z - 4, x + 4, y + 5, z + 4, Block.netherBrick.blockID);
	...
	private static void pillar(World world, Random rand, int x, int y, int z){
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x, y, z, x, y + 3, z, Block.stoneBrick.blockID);
