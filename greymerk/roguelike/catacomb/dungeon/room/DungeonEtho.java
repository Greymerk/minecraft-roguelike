...
public class DungeonEtho implements IDungeon {
	...
	public boolean generate(World world, Random rand, ITheme theme, int x, int y, int z) {
		...
		// corner pools
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z - 5, x - 2, y - 1, z - 2, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y - 1, z - 4, x - 3, y - 1, z - 3, Block.waterStill.blockID);
		WorldGenPrimitive.setBlock(world, x - 5, y, z - 5, Block.waterMoving.blockID);

		WorldGenPrimitive.fillRectSolid(world, rand, x + 2, y - 1, z + 2, x + 5, y - 1, z + 5, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y - 1, z + 3, x + 4, y - 1, z + 4, Block.waterStill.blockID);
		WorldGenPrimitive.setBlock(world, x + 5, y, z + 5, Block.waterMoving.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x + 2, y - 1, z - 5, x + 5, y - 1, z - 2, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y - 1, z - 4, x + 4, y - 1, z - 3, Block.waterStill.blockID);
		WorldGenPrimitive.setBlock(world, x + 5, y, z - 5, Block.waterMoving.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z + 2, x - 2, y - 1, z + 5, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y - 1, z + 3, x - 3, y - 1, z + 4, Block.waterStill.blockID);
		WorldGenPrimitive.setBlock(world, x - 5, y, z + 5, Block.waterMoving.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 1, y - 1, z - 5, x + 1, y - 1, z + 5, Block.grass.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z - 1, x + 5, y - 1, z + 1, Block.grass.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 1, y, z - 6, x + 1, y + 2, z - 6, 0);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 2, y - 1, z - 6, x - 2, y + 2, z - 6, Block.wood.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 2, y - 1, z - 6, x + 2, y + 2, z - 6, Block.wood.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 3, y - 1, z - 5, x - 3, y + 2, z - 5, Block.wood.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y - 1, z - 5, x + 3, y + 2, z - 5, Block.wood.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 2, y + 3, z - 6, x + 2, y + 3, z - 6, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 2, y + 4, z - 5, x + 2, y + 4, z - 5, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 2, y + 5, z - 4, x + 2, y + 5, z - 4, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y, z - 1, x - 6, y + 2, z + 1, 0);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y - 1, z - 2, x - 6, y + 2, z - 2, Block.wood.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y - 1, z + 2, x - 6, y + 2, z + 2, Block.wood.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z - 3, x - 5, y + 3, z - 3, Block.wood.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y - 1, z + 3, x - 5, y + 3, z + 3, Block.wood.blockID);
		
		WorldGenPrimitive.fillRectSolid(world, rand, x - 6, y + 3, z - 2, x - 6, y + 3, z + 2, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 5, y + 4, z - 2, x - 5, y + 4, z + 2, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 4, y + 5, z - 2, x - 4, y + 5, z + 2, Block.planks.blockID);
		...
		WorldGenPrimitive.fillRectSolid(world, rand, x - 3, y + 4, z - 3, x - 3, y + 5, z - 3, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x - 3, y + 4, z + 3, x - 3, y + 5, z + 3, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y + 4, z - 3, x + 3, y + 5, z - 3, Block.planks.blockID);
		WorldGenPrimitive.fillRectSolid(world, rand, x + 3, y + 4, z + 3, x + 3, y + 5, z + 3, Block.planks.blockID);
